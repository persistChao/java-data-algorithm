package com.answer.nio.netty.codedc;// Generated by the protocol buffer compiler.  DO NOT EDIT!
...
public final class StudentPOJO {
  ...
  public interface StudentOrBuilder extends
    ...
    /**
     * <pre>
     *Student类中 有一个属性 名字为id 类型为int32(protobuf类型） 1表示属性的序号，不是值
     * </pre>
     *
   ...
   *会在StudentPOJO 外部类生成一个内部类，踏实真正发送的POJO对象
   * </pre>
   *
